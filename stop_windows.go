...
// It folds taskkill's output into the error (mirroring runSchtasks) so the caller
// sees why the OS refused — e.g. "Access is denied" without admin — instead of a
// bare exit-status error.
